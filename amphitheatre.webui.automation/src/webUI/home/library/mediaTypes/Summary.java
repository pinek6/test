...
public class Summary extends MediaType
{
	...
	private By pdfContent = By.id("calculatorContentFrame");
	private By warning = By.cssSelector(".warningTextGroup");
	...
	public void waitForPageToLoad(WebDriver driver)
	{
		...
		wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(pdfContent));
		wait.until(ExpectedConditions.invisibilityOfElementLocated(warning));
	...
	{
		return commonMethods.isElementDisplayed(pdfContent, driver);
	}
