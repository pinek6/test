...
public class SharedSpecialty {
	
	private WebDriver driver;
	CommonMethods commonMethods = new CommonMethods(driver);
	
	private By SharedSpecialtyPopupLocator = By.cssSelector("div[id^='sls_widgets_components_profile_SharedSpecialties_']");
	private By titlePopupLocator = By.cssSelector("[id*=sls_widgets_components_profile_SharedSpecialties_] > span:nth-of-type(1)");
	
	/* Button Locators */
	private By okButtonLocator = By.id("dialogOk");
	private By dialogClosePopupLocator = By.cssSelector("h5[id*=sls_widgets_components_profile_SharedSpecialties_] > span:nth-of-type(2) > a > img");
	
	/* String Element Locator Constructors */
	private String sharedSpecialtyListLocator = "#peopleSpecialtiesHolder > div";
	private String next5LinkLocator = "#pagingButtons>span>a";
	private String counterLocator = "#peopleSpecialtiesHolder > div:nth-of-type(1)";
	private String memberListLocator = "#peopleSpecialtiesHolder";
	
	public SharedSpecialty(WebDriver driver)
	{
		this.driver=driver;
		waitForPopupToLoad();
	}
	...
	public void waitForPopupToLoad()
	{
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(sharedSpecialtyListLocator)));
		
		/* Reset the implicit wait */
		driver.manage().timeouts().implicitlyWait(Long.parseLong(config.getConfigProperties().getProperty("TIMEOUT")), TimeUnit.SECONDS);
	}
	
	public Boolean isSharedSpecialtyPopupDisplayed()
	{
		return commonMethods.isElementDisplayed(SharedSpecialtyPopupLocator, driver);
	}
	...
	public SharedSpecialty clickNext5Link()
	{
	...
	{
		int member = nth+1;
		driver.findElement(By.cssSelector(sharedSpecialtyListLocator + ":nth-of-type("+ member +")> div:nth-of-type(1)>a")).click();
	...
	{
		int member = nth+1;
		String name = driver.findElement(By.cssSelector(sharedSpecialtyListLocator + ":nth-of-type("+ member +")> div:nth-of-type(1)>a")).getText();
		return name;
	}
